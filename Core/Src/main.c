...
//		{
//			//uint8_t color_rgb[] = {colors[i][0], colors[i][1], colors[i][2]};
//
//			set_pixel_color(0, colors[i][0], colors[i][1], colors[i][2]);
//			set_pixel_color(1, colors[i][0], colors[i][1], colors[i][2]);
//			update_leds();
//			HAL_Delay(1000);
//			reset_colors();
//			HAL_Delay(1000);
